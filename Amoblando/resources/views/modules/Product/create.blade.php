            ...
            <div class="col-md-4">
                <form action="{{ route('product.store') }}" method="post">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <input name="name_product" id="name_product" type="text" class="form-control" required>
                    </div>
                    <div class="form-group mt-5">
                    ...
                    <div class="form-group mt-5">
                        ...
                        <input name="create_date" id="create_date" type="text" class="form-control" required>
                    </div>
                    <div class="form-group mt-5">
                        <label for="fk_category_id">CATEGORIA</label>
                        <input name="fk_category_id" id="fk_category_id" type="text" class="form-control" required>
                    </div>
